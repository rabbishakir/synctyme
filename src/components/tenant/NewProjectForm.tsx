...
export default function NewProjectForm({
  ...
  const [clientApprovedTimesheetRequired, setClientApprovedTimesheetRequired] =
    useState(false);
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="grid gap-2">
          ...
          <Input
            id="midClient"
            value={midClient}
            onChange={(e) => setMidClient(e.target.value)}
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="grid gap-2">
          ...
          <Input
            ...
            required
            disabled={!showRateFields}
          />
          {!showRateFields && (
            <p className="text-xs text-gray-400">Only Accounts can set rates</p>
          )}
        </div>
        <div className="grid gap-2">
      ...
      <div className="grid gap-2">
        ...
        <Input
          id="workAuth"
          value={workAuthDetails}
          onChange={(e) => setWorkAuthDetails(e.target.value)}
        />
      </div>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          onChange={(e) =>
            setClientApprovedTimesheetRequired(e.target.checked)
          }
          className="h-4 w-4 rounded border-gray-300"
        />
        <Label htmlFor="clientApproved">
          Client-approved timesheet required
        </Label>
      </div>
